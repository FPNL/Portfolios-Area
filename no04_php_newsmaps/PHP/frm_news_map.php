    ...
    <div id="wrap">
        ...
        <main> 
            ...
            <?php
                ...
                //  "src='https://www.google.com/maps/embed/v1/view?key=AIzaSyAY_TwkTuFMdT8db9foLLvdF1s91bF5v3Q&zoom=14&center=".$locationX.",".$locationY." '> ".
                //  "</iframe>";
            ...
            <div id="news_pops_column">
                ...
                <?php
                    ...
                    if(is_numeric($page)) {
                        ...
                        echo 
                        "<div class='news_pop'>".
                        "<div class='news_class'><a href='frm_news_view.php?action=class&tag=".$row["tagid"]."'><span class='news_clss_span'>居家生活</span></a> </div>".
