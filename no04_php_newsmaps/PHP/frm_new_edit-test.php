...
<head>
    ...
    <link rel="stylesheet" href="CSS/frm_new_edit.css">
    ...
    <div id="wrap">
        <header>
            ...
            "<div id='news_pers_inf_area'>".
                "<div id='pers_descr'>".
                    "<div id='pers_desc-1'>".
                        "<div id='pers_name'><a href=''><span>".$nickname."</span></a></div>".
            ...
            <div id="pers_page_column" >
                <div id="add_news" class="pers_page">
                    ...
                    <div id="add_news_main">
                        <form action="frm_news_edit.php" method="post" id="add_news_form" class="">
                            <div class="editTxt">
                                <label >
                                    <span>標題</span>
                                    <?php
                                    echo 
                                    "<input type='text' name='' id='' value='".$strtitle."' placeholder='輸入您的標題'>"
                                    ?>
                                </label>
                            </div>
                            ...
                            <div class="upload_img_row">
                                ...
                                <div id="upload_img">
                                    <div id="upload_img_items">
                                        <p class="upload_img_item">sssssssssssssss</p>
                                ...
                                <div id="review_content">
                                    ...
                                    // "<textarea rows='10' cols='100'>".$stcontent."</textarea>";
                                        "<div class='form-group pl-3 font-weight-bold'>".
                                            ...
                                            "<textarea class='form-control' name='' id='exampleFormControlTextarea1' rows='8'>".$stcontent."</textarea>".
                                        "</div>";
                                    ?>
                                </div>
                            </div>
                ...
                <div id="recommand_top5">
                    ...
                    <div id="recommand_top5_content">
                        <div class="recommand_top5_news">
                            <div class="recommand_top5_news_class"><a href=""><span>活動展覽</span></a></div>
                            <div class="recommand_top5_news_title"><a href=""><span>因為全棋同學的系統需求，雖然會員機制並不難，他一定也很快就學會了，而我還是寫此教學來引導他</span></a></div>
                        </div>
                        <hr class="recommand_top5_news_hr">
                        <div class="recommand_top5_news">
                                <div class="recommand_top5_news_class"><a href=""><span>活動展覽</span></a><a href=""><span>活動展覽</span></a></div>
                                <div class="recommand_top5_news_title"><a href=""><span>制並不難，他一定也很快就學會了，而我還是寫此教學來引導他</span></a></div>
                        </div>
                        <hr class="recommand_top5_news_hr">
                        <div class="recommand_top5_news">
                                <div class="recommand_top5_news_class"><a href=""><span>活動展覽</span></a></div>
                                <div class="recommand_top5_news_title"><a href=""><span>制並不難，他一定也很快就學會了，而我還是寫此教學</span></a></div>
                        </div>
                        <hr class="recommand_top5_news_hr">
                        <div class="recommand_top5_news">
                                <div class="recommand_top5_news_class"><a href=""><span>活動展覽</span></a><a href=""><span>活動展覽</span></a><a href=""><span>活動展覽</span></a></div>
                                <div class="recommand_top5_news_title"><a href=""><span>制並不難，他一定也很快就學會了，而我還是寫此教學</span></a></div>
                        </div>
                        <hr class="recommand_top5_news_hr">
                    </div>
